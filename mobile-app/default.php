...
<title>CodeRVA Main</title>
<link rel="stylesheet" href="style.css" />
<?php include_once("analytics.php") ?>
</head>
<body class="fixedcontain">
<nav class="tyler-nav"> <a class="logo-design" href="index.php"><img src="images/coderva.png" class="fixme" /></a> </nav>
<div id="myCarousel" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="carousel-item active"> <img class="first-slide" src="images/diverse.jpg" alt="Diverse Group" />
      <div class="container">
        <div class="carousel-caption"> <span class="blowup-front">CodeRVA</span>
          <p class="twohundredstyle">A hybrid high school, striving for diversity.</p>
          <p><a class="btn btn-lg btn-primary blowup" href="inquiry.php" role="button">Inquire Today</a></p>
        </div>
      </div>
    </div>
    <div class="carousel-item">
    <img class="second-slide" src="images/bootcampdiverse.jpg" alt="Diverse Group of Students" />
      <div class="container">
        <div class="carousel-caption"> <span class="blowup-front">Boot Camp</span>
          <p class="twohundredstyle">8th graders can participate in our week-long Boot Camp to see if they would like to participate in CodeRVA.</p>
          <p><a class="btn btn-lg btn-secondary lead blowup" href="bootcamp.php" role="button">More Information</a></p>
        </div>
      </div>
    </div>
    <div class="carousel-item"> <img class="third-slide" src="images/working-comp.jpg" alt="Working Comp" />
      <div class="container">
        <div class="carousel-caption"> <span class="blowup-front">Contact Us</span>
          <p class="twohundredstyle">If you feel there is a problem about our virtual reality school, send us an email, and we will try to fix it as soon as possible.</p>
          <p><a class="btn btn-lg btn-primary blowup" href="contact.php" role="button">Contact Our School</a></p>
        </div>
      </div>
    </div>
  </div>
...
<div class="row">
  ...
  <div class="col-lg-4"> <img class="img-circle" src="images/check.jpg" alt="Check" width="140" height="140">
    <h2>Guarenteed Internship</h2>
  ...
  <div class="col-lg-4"> <img class="img-circle" src="images/shake.JPG" alt="Career Path" width="140" height="140" />
    <h2>Career Path</h2>
...
<div class="row featurette">
  <div class="col-md-7 col-md-push-5">
    <h2 class="featurette-heading">Face to Face and <span class="text-muted">Online Instruction</span></h2>
    <p class="lead">CodeRVA offers more personalized learning to make sure the students receive the fullest potential of learning. This also makes sure that you know your child will succeed.</p>
  </div>
  <div class="col-md-5 col-md-pull-7"> <img class="featurette-image img-fluid center-block" src="images/onlineinstruction.jpg" alt="One To One Interaction"></div>
</div>
<hr class="featurette-divider">
<footer>
